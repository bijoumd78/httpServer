...
namespace AI::ImageProcessingUnit2
{
	...
	public:
		...
		HighResNet(const InferenceEngine::Core& ie, const std::string& deviceName, const std::string& xmlModel, const std::string& inputImagePath, const std::string& outputImagePath);
